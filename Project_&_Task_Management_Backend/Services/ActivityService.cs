...
namespace Project___Task_Management_Backend.Services
{
    public class ActivityService : IActivityService
    {
        ...
        public async Task<IEnumerable<ActivityResponseDto>> GetEntityActivity(EntityType entityType, int entityId)
        {
            var data = await _repo.GetByEntityAsync(entityType, entityId);
